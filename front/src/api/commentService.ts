...
export const getComments = async (parentId: string, parentType: CommentParentTypeEnum = CommentParentTypeEnum.POST): Promise<IComment[]> => {
  const endpoint = parentType === CommentParentTypeEnum.POST
